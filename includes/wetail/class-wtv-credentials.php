...
final class WTV_Credentials extends License_checker {
    ...
    public static function check() {
        ...
        if ( empty( $license_key ) ) {
            $license_key = get_option( 'wetail_license_key' ); //IF UPGRADE FAILS
            if ( empty( $license_key ) ) {
                return false;
            }
            update_option(static::KEY_OPTION_NAME, $license_key );
        }
...
abstract class License_checker {
     ...
     */
    final public static function is_active( string $license_key ): bool {
     ...
     * @return array
     */
    final private static function fetch_license( string $license_key ): array {
     ...
     * @return array
     */
    final private static function fetch_license_from_cache() {
     ...
     * @return array
     */
    final private static function fetch_remote_license( string $license_key, string $token ): array {
     ...
     * @return string
     */
    final private static function get_domain_name(): string {
     ...
     * @return string
     */
    final private static function get_ip_address(): string {
     ...
     * @return string
     */
    final private static function generate_license_token( string $license_key ): string {
     ...
     * @return array
     */
    final private static function parse_response_body( string $body, string $token = '' ): array {
        $license_status = [];
     ...
     * @return void
     */
    final private static function cache_license( array $license, string $license_key ): void {
        if ( true === static::DEBUG ) {
